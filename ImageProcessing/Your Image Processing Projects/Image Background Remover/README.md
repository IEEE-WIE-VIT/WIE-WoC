...
- This project contains a script bg_remover.py which helps to remove the background of an image. <br>
- It uses Open CV library to manipulate pixels of the image. <br>
- Numpy is used because Open CV stores images in form of numpy array and it can be manipulated easily by performing numpy operations. <br>
...
<img src="Images/Img%20Screenshot%201.png"/><br>

<img src="Images/Img%20Screenshot%202.png"/><br>
